...
def mainpost(request):
	...
	if email == "07devthakur07@gmail.com":
...
#	from email.mime.text import MIMEText-----------------
	...
	try:
		...
		message = "You are Signed out, Please Signin Again."
		return render(request,'form.html', {'message':message})
...
#==============================================email sending starts here===================#
	"""all_users = database.child("Daily_Report").child(UID).child("details").get()
					...
					toaddr = "07devthakur07@gmail.com" #================receiver mail
					msg = MIMEMultipart()
					msg['From'] = fromaddr
					msg['To'] = toaddr
